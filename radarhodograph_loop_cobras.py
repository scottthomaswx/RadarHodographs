# -*- coding: utf-8 -*-
"""RadarHodograph_Loop.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/scottthomaswx/RadarHodographs/blob/main/RadarHodograph_Loop.ipynb
...
start = tz.localize(datetime(2023,8,24,22,0))
end = tz.localize(datetime(2023,8,25,3,0))

#Radar
radar_id = 'KDTX' #Make Uppercase
...
#Surface Winds
sfc_status = 'Auto' #Enter Auto, Manual, or None

#Manual Entry
sfc_dir = 777
sfc_spd = 777
nearest_asos = 'KPTK' #Enter 999 If Not Using
...
# dellist = glob.glob('/content/radar_data/*MDM*')
...
"""#Create folders into zip files for easy download"""

!zip -r ./hodo.zip ./hodos
!zip -r ./sr_hodo.zip ./sr_hodos

"""#Reset Hodograph Folders (if desired)"""
